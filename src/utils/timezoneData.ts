...
// List of timezones compatible with Python tz.gettz
...
// Utility function to find timezone by partial name
export function findTimezonesBySearch(search: string): string[] {
